...
//    navi2.jz_fullScreenInteractivePopGestureRecognizer=YES;
    ...
    JTNavigationController * navi3 = [[JTNavigationController alloc]initWithRootViewController:third];
    
    self.viewControllers = [NSArray arrayWithObjects:navi1,navi2,navi3,nil];
    
    [self creatButtonWithNormalName:@"列表" andSelectName:@"列表-1" andTitle:Title1 andIndex:0];
    [self creatButtonWithNormalName:@"收藏" andSelectName:@"收藏-1" andTitle:Title2 andIndex:1];
    [self creatButtonWithNormalName:@"关于" andSelectName:@"关于-1" andTitle:Title3 andIndex:2];
...
- (void)creatButtonWithNormalName:(NSString *)normal andSelectName:(NSString *)selected andTitle:(NSString *)title andIndex:(int)index{
    ...
    [customButton setTitleColor:LXMainColor forState:UIControlStateSelected];
