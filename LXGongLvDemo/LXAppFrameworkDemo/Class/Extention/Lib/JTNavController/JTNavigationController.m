...
//        [rootViewController.navigationController.navigationBar setTitleTextAttributes:attributes];
        ...
        //title的大小和颜色，方法二
        [rootViewController.navigationController.navigationBar setTitleTextAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:17],NSForegroundColorAttributeName:[UIColor whiteColor]}];
        //修改itemleftbtn字体颜色
        [rootViewController.navigationController.navigationBar setTintColor:[UIColor whiteColor]];
        
        [rootViewController.navigationController.navigationBar setBarTintColor:LXMainColor];
    }
    return self;
}
